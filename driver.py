...
caesarcipher.encrypt('<enter full path of plain text file>',
                     ...
                     key, deletesource=False) # setting deletefile=True deletes the plain text file

caesarcipher.decrypt('<enter fullpath of encrypted file>',
                     '<enter fullpath of decrypted file>',
                     key, deletesource=False) # setting deletefile=True deletes the encrypted text file
